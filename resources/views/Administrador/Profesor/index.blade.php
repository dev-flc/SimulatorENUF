...
.card.hovercard .cardheader {
    background: url("/img/desing/09.png");
...
.btn{ border-radius: 50%; width:32px; height:32px; line-height:20px;  }
...
<div class="container-fluid">
    <a href="{{ route('profesores.create') }}">Create profesores</a>
<br>
  <div class="row">
    ...
    <div class="col-sm-3">
            <div class="card hovercard">
                ...
                <div class="bottom">
                    ...
                    <a class="btn btn-success btn-twitter btn-sm" href="#"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span>
                    </a>
                </div>
            </div>
        </div>
